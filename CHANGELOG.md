...
### Changed
- Launcher title bar now shows current version (e.g. "Zenith Launcher v1.0.3")
- Simplified update notification window (removed release notes display)
- Improved silent installer flags for truly background updates
